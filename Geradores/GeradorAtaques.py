...
DicionarioAtaques = {
    ...
    "Bençao": lambda: importlib.import_module("Dados.Ataques.Fada").Bençao,
    ...
    "Psiquico Desgastante": lambda: importlib.import_module("Dados.Ataques.Psiquico").Psiquico_Desgastante,
